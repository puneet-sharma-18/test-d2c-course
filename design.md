...
## Overview
An editorial precision interface for a D2C founder's operating tools: weekly briefs, dashboards, creative reviews, customer reports. The aesthetic is quietly confident. Bold display typography, generous spacing, gallery-frame card surfaces. The mood is professional and modern without being sterile. High information density balanced by breathing room. Adapted from the Genesis design system at designmd.ai/chef/genesis.
